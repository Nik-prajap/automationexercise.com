...
#Test Case 6: Contact Us Form
  Scenario: User should log the contact us form
    ...
    And I enter "Nandini" name to name field
    And I enter "PrimeTesting102@gmail.com" email to email field
...
#  Test Case 10: Verify Subscription in home page
  Scenario: User should verify the subscription in home page
    ...
    And I enter email address in input "PrimeTesting102@gmail.com"
...
#  Test Case 24: Download Invoice after purchase order
  Scenario: User should Download Invoice after purchase order
    ...
    And I fill all details in signup page "Mrs" "Testing123" "11" "March" "1999" "Nandini" "Prajapati" "SetuKrupa" "Shahibaug" "India" "Gujarat" "Ahmedabad" "380005" "9825098250"
